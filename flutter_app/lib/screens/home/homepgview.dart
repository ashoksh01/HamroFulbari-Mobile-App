...
import 'package:plant_app/screens/home/homepagedetailview.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            child: Icon(Icons.shopping_cart_checkout, color: green),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (builder) => HomePageDetailView(plant: plants[index]),
          ),
        );
      },
      child: Container(
